#!/usr/bin/env bash
# Build the barq-chat-form-c Rust library required by this C# project.
...
LIB_DIR="$BARQ_C_DIR/target/release"
...
echo "  Windows: copy $LIB_DIR/barq_chat_form_c.dll next to your executable"
